...
for k=1:k_max
    ...
    guk = xu0+0.0001*(xu0-xu0_old);
    gvk = xv0+0.0001*(xv0-xv0_old);
    yk = yuk-yvk;
    Ayk = A(yk);
    tempy = AT(Ayk)-Atb;
    ...
    if k==1
        ...
        switch method
            ...
            case 'DIDFPM'
                ...
                suk = xu0-xu0_old;
                svk = xv0-xv0_old;
                %syktwk = (wuk'*suk)*wuk+(wvk'*svk)*wvk; 
                Normsk2 = suk'*suk+svk'*svk;
                wksk = wuk'*suk+ wvk'*svk;
                
                tea = (Normsk2)^2/((wksk)^2+0.0001*(Normsk2)^2);                
                dku = -tea*Fyuk;
                dkv = -tea*Fyvk;             
        end
    end
    ...
    xu1 =(1-0.28)* guk + 0.28*(yuk-rho*xik*Fzuk);
    xv1 =(1-0.28)* gvk + 0.28*(yvk-rho*xik*Fzvk);
    x1 = xu1-xv1;
